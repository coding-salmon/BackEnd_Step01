<!-- 페이지 지시자
원래 jsp를 다른 언어도 지원하려고 했으나 , 워낙 기술의 빠른 발달로 다른 Web방식도 나오니깐
그냥 jsp는 자바만 지원하게됐다.

아래는 jsp가 자바로 변환된다는 약속이다.  -->
...
<!-- Model One 방식
	...
	->나중에 java코드의 Controller는 Servlet으로, DB/Query는 java 클래스로 만들고
...
/*jsp 선언문
메서드나 필드 선언할 때 이렇게 하면 Calculator_jsp의 클래스의 멤버가 된다. */
